...
#include "maps_test.h"	// Includes the header of this component
...
MAPS_BEGIN_ACTIONS_DEFINITION(MAPStest)
    //MAPS_ACTION("aName",MAPStest::ActionName)
MAPS_END_ACTIONS_DEFINITION

// Use the macros to declare this component (test) behaviour
MAPS_COMPONENT_DEFINITION(MAPStest,"test","1.0",128,
