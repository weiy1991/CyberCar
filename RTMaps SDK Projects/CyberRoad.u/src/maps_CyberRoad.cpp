...
#include "maps_CyberRoad.h"	// Includes the header of this component
#include "cmath"
// Use the macros to declare the inputs
MAPS_BEGIN_INPUTS_DEFINITION(MAPSCyberRoad)
    //MAPS_INPUT("iName",MAPS::FilterInteger32,MAPS::FifoReader)
	MAPS_INPUT("Laser_Long",MAPS::FilterInteger32,MAPS::LastOrNextReader)
    MAPS_INPUT("Laser_Short",MAPS::FilterInteger32,MAPS::LastOrNextReader)
    MAPS_INPUT("",MAPS::FilterInteger32,MAPS::LastOrNextReader)
    MAPS_INPUT("",MAPS::FilterInteger32,MAPS::LastOrNextReader)
MAPS_END_INPUTS_DEFINITION

// Use the macros to declare the outputs
MAPS_BEGIN_OUTPUTS_DEFINITION(MAPSCyberRoad)
    //MAPS_OUTPUT("oName",MAPS::Integer32,NULL,NULL,1)
MAPS_END_OUTPUTS_DEFINITION

// Use the macros to declare the properties
MAPS_BEGIN_PROPERTIES_DEFINITION(MAPSCyberRoad)
    //MAPS_PROPERTY("pName",128,false,false)
MAPS_END_PROPERTIES_DEFINITION

// Use the macros to declare the actions
MAPS_BEGIN_ACTIONS_DEFINITION(MAPSCyberRoad)
    //MAPS_ACTION("aName",MAPSCyberRoad::ActionName)
MAPS_END_ACTIONS_DEFINITION

// Use the macros to declare this component (CyberRoad) behaviour
MAPS_COMPONENT_DEFINITION(MAPSCyberRoad,"CyberRoad","1.0",128,
